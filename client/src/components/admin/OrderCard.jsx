...
const OrderCard = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 mb-4 hover:shadow-lg transition-shadow">
      ...
      {/* Delivery Address - Show only for delivery orders with address */}
      {order.deliveryOption === "delivery" && order.deliveryAddress && (
        <div className="bg-blue-50 p-3 rounded-lg border-2 border-blue-200 mt-3">
